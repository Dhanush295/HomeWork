...
SELECT TOP 6  Name + ' ' + Color AS [Color Name], Color
FROM Production.Product
WHERE Color IS NOT NULL
...
-- (Q13) Write a query so you retrieve rows that have a Name that begins with the letters SPO, but is then not followed by the letter K. 
...
-- (Q15) Write a query that retrieves the unique combination of columns ProductSubcategoryID and Color from the Production.Product table. 
