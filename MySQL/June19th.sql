...
SELECT cr.Name as Country, sp.Name as Province
FROM Person.CountryRegion cr JOIN Person.StateProvince as sp ON cr.CountryRegionCode = sp.CountryRegionCode
...
SELECT c.ContactName, COUNT(od.ProductID) AS NumberOfProductsBought
FROM Customers c
JOIN Orders o ON c.CustomerID = o.CustomerID
...
SELECT c.CustomerID, COUNT(od.ProductID) AS NumberOfProductsBought
FROM Customers c
JOIN Orders o ON c.CustomerID = o.CustomerID
JOIN [Order Details] od ON o.OrderID = od.OrderID
...
SELECT 'Customer' AS EntityType, CompanyName AS EntityName, City
FROM Customers
UNION ALL
SELECT 'Supplier' AS EntityType, CompanyName AS EntityName, City
FROM Suppliers;
